  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            {stores.map((store, i) => (
              <div key={store.id}>
                ...
                <AnimatedBar
                  pct={(store.monthlySales / maxSales) * 100}
                  color={TONE_COLOR.clay}
                  opacity={0.5 + i * 0.15}
                  trackClassName="h-3"
                />
              </div>
          ...
          <div className="space-y-4">
            {marginByCategory.map((c) => (
              <div key={c.category}>
                ...
                <AnimatedBar pct={(c.margin / maxMargin) * 100} color={TONE_COLOR.success} />
              </div>
            ))}
        ...
        <SellerRankingCard className="lg:col-span-2" />
      </div>
    </>
  );
}
